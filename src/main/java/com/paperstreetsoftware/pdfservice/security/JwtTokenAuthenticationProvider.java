package com.paperstreetsoftware.pdfservice.security;

import com.paperstreetsoftware.pdfservice.config.props.SecurityProperties;
import com.paperstreetsoftware.pdfservice.security.exception.JwtAuthenticationException;
...
public class JwtTokenAuthenticationProvider implements AuthenticationProvider {
    ...
    public void init() {
        try {
            ...
            publicKey = kf.generatePublic(new X509EncodedKeySpec(IOUtils.toByteArray(securityProperties.getPublicKey())));
        } catch (IOException | InvalidKeySpecException | NoSuchAlgorithmException e) {
            throw new IllegalStateException("Cannot load jwt verification public key.", e);
        }
    }
